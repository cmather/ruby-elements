...
describe "Elements::Template::GeneratedFragment" do
  ...
  it "should work" do
    ...
    # column: 1
    left_term_ast = term_ast_class.new("2", create_location([0,1,0], [1,1,1]))

    # "3" is located from index: 4, line: 1, column: 4 to index: 5, line: 1,
    # column: 5
    right_term_ast = term_ast_class.new("3", create_location([4,1,4], [5,1,5]))

    op_ast = op_ast_class.new(left_term_ast, right_term_ast, create_location([0,1,0], [5,1,5]))
...
describe "Elements::Template::CodeGen" do
end
